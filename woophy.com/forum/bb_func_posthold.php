<?php
/*
This file is part of miniBB. miniBB is free discussion forums/message board software, without any warranty. See COPYING file for more details. Copyright (C) 2006 Paul Puzyrev. www.minibb.net
...
$userDataFields=<<<out
{$l_sub_name}: <input type="text" size="10" maxlength="40" name="user_usr" value="{$user_usr}" class="textForm" /> {$l_sub_pass}: <input type="password" size="10" maxlength="32" name="user_pwd" class="textForm" /><br /><br />
out;
...
elseif($topicTitle!=''){
$topicTitleField="{$l_topic}:<br /><input type=\"text\" name=\"topicTitle\" class=\"textForm\" style=\"width:450px;\" value=\"{$topicTitle}\" /><br /><br />";
...
elseif($postText!=''){
$postTextField="{$l_message}:<br /><textarea name=\"postText\" cols=\"38\" rows=\"10\" class=\"textForm\" style=\"width:450px;\">{$postText}</textarea><br /><br />";
