...
switch($db_connection){
	...
	case 'staging':
		...
		$db_user		= 'helspawn99';
		$pb_pass		= 'katja99';
		$db_slave_host 	= 'ec2-46-137-139-91.eu-west-1.compute.amazonaws.com'; // this is the qa master db server
...
//::End change::
	...
	define('DISABLE_ADS', 						false); //disable ad components on dev environment
